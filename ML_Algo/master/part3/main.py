...
def main():
    ...
    optimizer = optim.SGD(distributed_model.parameters(), lr=0.1,
                          momentum=0.9, weight_decay=0.0001)
    # running training for one epoch
    for epoch in range(1):
        train_model(distributed_model, train_loader, optimizer, training_criterion, epoch)
        test_model(distributed_model, test_loader, training_criterion)
