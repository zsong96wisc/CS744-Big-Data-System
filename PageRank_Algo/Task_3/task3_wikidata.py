...
conf = SparkConf().setAppName("PageRankWiki_task3")
...
filteredLink2EachDest = link2EachDest.filter(lambda row: ":" not in row[1] or row[1].startswith("Category:")).persist(storageLevel=StorageLevel(True,False,False,False,1))
